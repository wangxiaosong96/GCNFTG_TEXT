...
if __name__ == '__main__':
    ...
    np.savez_compressed('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_disease__case_study//task_Tp_balanced_10knn_lr0.001_fold0.npz', ys_train = ys_train, ys_test = ys_test)

    #python -m graphsaint.pytorch_version.train_saveys --data_prefix miRNA_disease_data/task_Td__testlabel0_5knn_edge_fold4 --train_config ./train_config/table2/ppi2_e_lr0.001.yml > ./miRNA_disease__case_study/20200115_Td_balanced_5knn_lr0.001_fold4.out --gpu 0
