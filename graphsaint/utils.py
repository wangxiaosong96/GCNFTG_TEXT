...
def load_data(prefix, normalize=True):
    ...
    """
    adj_full = scipy.sparse.load_npz('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_diasease_data/Tp__testlabel0_10knn_edge_fold0/adj_full.npz'.format(prefix)).astype(np.bool)
    adj_train = scipy.sparse.load_npz('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_diasease_data/Tp__testlabel0_10knn_edge_fold0/adj_train.npz'.format(prefix)).astype(np.bool)
    role = json.load(open('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_diasease_data/Tp__testlabel0_10knn_edge_fold0/role.json'.format(prefix)))
    feats = np.load('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_diasease_data/Tp__testlabel0_10knn_edge_fold0/feats.npy'.format(prefix))
    class_map = json.load(open('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_diasease_data/Tp__testlabel0_10knn_edge_fold0/class_map.json'.format(prefix)))
